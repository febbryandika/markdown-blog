  ...
  return (
    <section aria-labelledby="new-post-heading">
      <header className="mb-6">
        <h1 id="new-post-heading" className="text-3xl font-bold tracking-tight leading-tight">New post</h1>
        <p className="mt-1 text-sm text-muted-foreground">Write your post in Markdown.</p>
      </header>
